    ...
    e.addEventListener('click', () => {
        switch(btn_id) {
            ...
            case 'btn-theme':
                ...
                status_bar_chrome.setAttribute("content", body.classList.contains('dark') ? "#222324" : "#52ffb7")

                let status_bar_win = document.querySelector("meta[name='msapplication-navbutton-color'")
                status_bar_win.setAttribute("content", body.classList.contains('dark') ? "#222324" : "#52ffb7")

                let status_bar_ios = document.querySelector("meta[name='apple-mobile-web-app-status-bar-style'")
                status_bar_ios.setAttribute("content", body.classList.contains('dark') ? "#222324" : "#52ffb7")
                break
            case 'btn-pause':
                gamePause()
                let btn_play = document.querySelector('#btn-play')
